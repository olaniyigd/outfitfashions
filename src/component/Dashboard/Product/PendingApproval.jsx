                  ...
                  <tr key={index} className="border-b">
                    ...
                    <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      ...
                      >
                        ...
                        src={item.images} height={100} width={100} alt="jssh"/>
                      </div>
                    </td>
      ...
      >
        ...
        {expandedRow === index && (
                <div className="flex flex-col gap-4 items-center  shadow">
                  <p className="hover:bg-[#E3EEEC] px-[30px] py-[10px] hover:text-[#008B74]">Accept Request</p>
                  <p onClick={() => setRejectProduct(true)} className="hover:bg-[#E3EEEC] px-[30px] py-[10px] hover:text-[#008B74]">Reject request</p>
                </div>
              )}
      </div>
    </div>
...
<RejectProduct 
          ...
          setRejectProduct={setRejectProduct} />
